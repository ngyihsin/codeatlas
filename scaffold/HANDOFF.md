...
- `template_version` — the framework version this instance is pinned to (see `VERSION` / `CHANGELOG.md`). Bump it only when you run `update-framework.sh` and complete the migration notes.
