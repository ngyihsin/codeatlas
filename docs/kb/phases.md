...
**Exit gate**
- [◐] M2.1 ingest verified on a schema-faithful SCIP fixture (precise edges produced, MCP precedence) — **live scip-clang/ORT run BLOCKED in this env** (no binary/build)
